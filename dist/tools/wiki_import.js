 ...
 */
function hasWikiFrontmatter(fm) {
 ...
 */
function buildDraftFrontmatter(existingFm, sourceFile) {
...
export function registerWikiImport(server, ctx) {
    server.registerTool("wiki_import", {
        description: "Read a .md file from any path (inside or outside the vault) and prepare it for wiki ingestion. " +
        ...
        inputSchema: {
            file_path: z
                .string()
                .describe("Absolute or ~-relative path to the .md file to import. " +
                "Can be anywhere on disk — not limited to the vault."),
            suggested_wiki_path: z
                .string()
                .optional()
                .describe("Where to place the page in the wiki, e.g. _wiki/infra/redis-tips.md. " +
...
//# sourceMappingURL=wiki_import.js.map